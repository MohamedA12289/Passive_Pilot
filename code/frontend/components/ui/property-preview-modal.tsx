                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="p-5 rounded-xl bg-black border-2 border-amber-500/40 hover:border-amber-500/60 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-xs text-amber-300 font-montserrat font-bold uppercase tracking-wide">
                          AFTER-REPAIR VALUE
                        </p>
                      </div>
                      <p className="text-4xl font-montserrat font-black text-amber-400 mb-2">
                        ${arv.toLocaleString()}
                      </p>
                    ...
                    <div className="p-5 rounded-xl bg-black border-2 border-amber-500/40 hover:border-amber-500/60 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-xs text-amber-300 font-montserrat font-bold uppercase tracking-wide">MAX OFFER</p>
                      </div>
                      <p className="text-4xl font-montserrat font-black text-amber-400 mb-2">
                        ${mao.toLocaleString()}
                      </p>
                    ...
                    {/* Repairs Card */}
                    <div className="p-5 rounded-xl bg-black border-2 border-gray-700/40 hover:border-gray-700/60 transition-all">
                      <div className="flex items-center gap-2 mb-3">
                        <Wrench className="w-5 h-5 text-gray-400" />
                        <p className="text-xs text-gray-300 font-montserrat font-bold uppercase tracking-wide">
                          REPAIRS
                        </p>
                      </div>
                      <p className="text-4xl font-montserrat font-black text-white mb-2">
                        ${repairs.toLocaleString()}
                      </p>
                    ...
                    <div className={`p-5 rounded-xl bg-black border-2 transition-all ${
                      sellerAsking === 0 ? 'border-red-500/40 hover:border-red-500/60' : dealStrength.borderColor
                    }`}>
                      <div className="flex items-center gap-2 mb-3">
                        <Star className={`w-5 h-5 ${
                          sellerAsking === 0 ? 'text-red-400' : dealStrength.color
                        }`} />
                        <p className="text-xs text-gray-300 font-montserrat font-bold uppercase tracking-wide">DEAL STRENGTH</p>
                      </div>
                      <p className={`text-3xl font-montserrat font-black mb-2 ${
                        sellerAsking === 0 ? 'text-red-400' : dealStrength.color
                      }`}>
                        {sellerAsking === 0 ? 'RISKY' : dealStrength.grade}
                      </p>
                      <p className="text-xs text-gray-400 font-poppins">
                        {sellerAsking === 0 
