                ...
                {financing === 'cash' && (
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="p-5 rounded-xl bg-black border-2 border-amber-500/40 hover:border-amber-500/60 transition-all">
                      ...
                      <p className="text-4xl font-montserrat font-black bg-gradient-to-r from-amber-400 to-yellow-300 bg-clip-text text-transparent mb-2">
                        ${arv.toLocaleString()}
                      </p>
                    ...
                    {/* Repairs Card */}
                    {repairs > 0 && (
                      <div className="p-5 rounded-xl bg-black border-2 border-gray-600/40 hover:border-gray-600/60 transition-all">
                        <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className={`p-5 rounded-xl bg-black border-2 transition-all ${
                      sellerAsking === 0 ? 'border-red-500/40 hover:border-red-500/60' :
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <div className={`p-2 rounded-lg border ${
                          sellerAsking === 0 ? 'bg-red-500/10 border-red-500/30' :
                          profit >= 30000 ? 'bg-emerald-500/10 border-emerald-500/30' :
                          profit >= 20000 ? 'bg-blue-500/10 border-blue-500/30' :
                          profit >= 10000 ? 'bg-amber-500/10 border-amber-500/30' :
                          'bg-red-500/10 border-red-500/30'
                        }`}>
                          <Star className={`w-5 h-5 ${
                            sellerAsking === 0 ? 'text-red-400' :
                      ...
                      <p className="text-xs text-gray-400 font-poppins">
                        {sellerAsking === 0 ? 'Calculate to see spread' : `${mao >= sellerAsking ? '+' : ''}$${Math.abs(mao - sellerAsking).toLocaleString()} ${mao >= sellerAsking ? 'room' : 'gap'}`}
                      </p>
                    </div>
                  </div>
                )}
