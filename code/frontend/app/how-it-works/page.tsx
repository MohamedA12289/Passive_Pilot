    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main>
        <Section title="How it works">
          <p>1) Create a campaign. 2) Pick your target area on the map. 3) Choose provider + filters. 4) Pull leads. 5) Review and export.</p>
          <p>Everything is designed to be clear, step-by-step — no guessing.</p>
        </Section>
      </main>
      <Footer />
    </div>
