...
export default function Page() {
  ...
  <li><a className="text-yellow-300 hover:underline" href="/dashboard">Dashboard</a></li>
  <li><a className="text-yellow-300 hover:underline" href="/how-it-works">How it works</a></li>
  <li><a className="text-yellow-300 hover:underline" href="/pricing">Pricing</a></li>
</ul>
        </Section>
      </main>
      <Footer />
