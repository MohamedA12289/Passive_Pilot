    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main>
        <Section title="Onboarding guide">
          <p>Step-by-step onboarding lives here: setup, keys, basic workflow, exporting, and best practices.</p>
          <p>We can later auto-link this to the campaign flow so users never get lost.</p>
        </Section>
      </main>
      <Footer />
    </div>
