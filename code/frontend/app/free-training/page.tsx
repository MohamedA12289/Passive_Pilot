...
export default function Page() {{
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      <Navigation />
      <main>
        <Section title="Free training">
          <p>Training content lives here. Add videos, PDFs, or onboarding modules as you build.</p>
          <p>Keep the same premium dark + gold style across marketing and app.</p>
        </Section>
      </main>
      <Footer />
    </div>
