...
export default function Page() {{
  ...
  <li><b>Do I need API keys?</b> Not yet — the app supports placeholders and we’ll plug them in later.</li>
  <li><b>Is SMS included?</b> No — we removed SMS from the build.</li>
  <li><b>Can I export by ZIP?</b> Yes — export is a core part of the flow.</li>
</ul>
        </Section>
      </main>
      <Footer />
